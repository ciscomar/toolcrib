...
let tableSalidas = $('#tableSalidas').DataTable({
    dom: 'Blfrtip',
    searching: true,
    paging: true,
    info: true,
    buttons: [
        {
            extend: 'excelHtml5',
            title: `Reporte Salidas ${fileDate.toLocaleString()}`,
            filename: `Reporte Salidas ${fileDate.toLocaleString()}`,
            className: "d-none"
        }
    ],
